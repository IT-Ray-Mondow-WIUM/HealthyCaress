                        ...
                        <div class="card shadow rounded-2 overflow-hidden border border-primary border-1">
                            ...
                            <div class="row mb-3 px-2">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group mb-2">
                                        <textarea name="anamnesis" id="anamnesis" rows="3" class="form-control" placeholder="Catatan anamnesis"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <label for="pemeriksaanfisik" class="form-label fw-bold">Pemeriksaan
                                        Fisik:</label>
                                    <div class="input-group mb-2">
                                        <textarea name="pemeriksaanfisik" id="pemeriksaanfisik" rows="3" class="form-control"
                                            placeholder="Catatan hasil pemeriksaan fisik"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="tab-pane"><br>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row g-3 align-items-end">
                                    <div class="col-md-4">
                                        ...
                                        <select id="list_bhp" name="list_bhp" class="form-select" wire:model="bhp"
                                            required>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" placeholder="Jumlah ..."
                                            id="jumlah_bhp" wire:model="jumlah_bhp" />
                                    </div>
                        ...
                        <div class="card shadow rounded-2 overflow-visible border border-primary border-1 mt-3">
                            ...
                            <div class="card-body">
                                <div class="row g-3 align-items-end">
                                    <div class="col-md-4">
                                        <label for="list_tindakan" class="form-label">Resep</label>
                                        <select id="list_tindakan" name="list_tindakan" class="form-select"
                                            wire:model="bhp" required>
                                    ...
                                    <div class="col-md-4">
                                        <label for="jumlah_tindakan" class="form-label">Jumlah</label>
                                        <input type="text" class="form-control" placeholder="Jumlah ..."
                                            id="jumlah_reset" wire:model="jumlah_resep" />
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped table-hover align-middle">
                                        ...
                                        <tbody>
                                            <tr class="text-center">
                                                <th class="col">ICD X</th>
                                                <th colspan="2" class="col">Keterangan</th>
                                                <th class="col">Kasus</th>
                                            </tr>
                                            @forelse($icdxList as $index => $item)
                                                <tr>
                                                    <td>{{ $item['kode'] }}</td>
