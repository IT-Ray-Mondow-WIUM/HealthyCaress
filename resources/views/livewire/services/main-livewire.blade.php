            ...
            <div class="">
                ...
                <div class="tab-pane"><br>
                    <div class="card shadow rounded-2 overflow-hidden border border-primary border-1">
                        <div class="card-header bg-primary text-white fw-semibold p-2 mb-1 ">#Pemeriksaan Pasien</div>
                        {{-- Baris 1 --}}
                        ...
                        <div class="row mb-3 px-2">
                            ...
                            {{-- Pemeriksaan Fisik --}}
                            <div class="col-md-6">
                                <label for="pemeriksaanfisik" class="form-label fw-bold">Pemeriksaan Fisik:</label>
                                <div class="input-group mb-2">
                ...
                @elseif($activeTab === 'diagnosa') {{-- DIAGNOSA --}}
                <div class="tab-pane"><br>
                ...
                @elseif($activeTab === 'tindakan') {{-- Tindakan --}}
                <div class="tab-pane"><br>
                    <div class="card shadow rounded-2 overflow-visible border border-primary border-1">
                        <div class="card-header bg-primary text-white fw-semibold p-2">
                            #Tindakan
                ...
                @elseif($activeTab === 'detail') {{-- Detail --}}
                <div class="tab-pane"><br>
                    <div class="card shadow rounded-2 overflow-visible border border-primary border-1">
                        <div class="card-header bg-primary text-white fw-semibold p-2">
                            #Detail
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-sm">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td colspan="3">
                                                <a href="#"><i class="bi bi-printer-fill"></i> Cetak Lembar RM</a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="3">
                                                <a href="#"><i class="bi bi-printer-fill"></i> Cetak Surat Rujukan</a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="3">
                                                <a href="#"><i class="bi bi-printer-fill"></i> Cetak Surat Keterangan
                                                    Sakit</a>
                                            </td>
                                        </tr>
                                    </tbody>
